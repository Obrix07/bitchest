<template>
    <div class="h-screen flex">
        ...
        <div class="flex flex-col m-auto text-center justify-center">
            <h2
                class="mt-5 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"
            >
                <span
                ...
                >
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="px-6 py-4">
                                {{ currencyFormatter(item.wallet_balance) }} €
                            </td>
...
export default {
    ...
    methods: {
        ...
        deleteClient(id) {
            if (
                !window.confirm("Êtes-vous sûr de vouloir supprimer ce client?")
            ) {
                return;
            }
            axios
