                            ...
                            >
                                <div class="relative">
                                    <input
                                        ...
                                        placeholder="Nom"
                                        required
                                        class="peer rounded placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600"
                                    />
                                    <label
                                ...
                                <div class="relative">
                                    <input
                                        ...
                                        type="email"
                                        required
                                        class="mt-5 rounded peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600"
                                    />
                                    <label
